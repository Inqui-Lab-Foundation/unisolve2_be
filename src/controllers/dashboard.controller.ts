...
export default class DashboardController extends BaseController {
    ...
    protected async getEvaluatorStats(req: Request, res: Response, next: NextFunction): Promise<Response | void> {
        try {
            ...
            const final_evaluation_final = await db.query(`SELECT COUNT(challenge_response_id) FROM unisolve_db.challenge_responses WHERE final_result in ('1','2')`, { type: QueryTypes.SELECT });
